export default {
  ...
  'organization.member.tableColumnName': '姓名',
  'organization.member.tableColumnPhone': '手机',
  'organization.member.tableColumnPro': '项目',
  'organization.member.tableColumnUserGroup': '用户组',
  'organization.member.tableColumnStatus': '状态',
  'organization.member.tableColumnActions': '操作',

...
public class MinioRepository implements FileRepository {
    ...
    public static final String BUCKET = "orchid";
    ...
    private void removeObjects(String bucketName, String filePath) throws Exception {
        List<String> objects = listObjects(bucketName, filePath);
